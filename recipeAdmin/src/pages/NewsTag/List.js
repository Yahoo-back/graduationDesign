...
import NewsTagComponent from './NewsTagComponent';
...
class TableList extends PureComponent {
  ...
  render() {
    const { newsTagList, total } = this.props.newsTag;
