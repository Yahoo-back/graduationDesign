export default {
  ...
  'menu.home': '首页',
  'menu.article': '菜谱管理',
  'menu.article.list': '菜谱列表',
  'menu.article.create': '菜谱创作',
  'menu.timeAxis': '时间轴',
  'menu.timeAxis.list': '时间轴列表',
  'menu.tag': '菜谱标签管理',
  'menu.tag.list': '菜谱标签列表',
  'menu.otherUser': '用户管理',
  'menu.otherUser.list': '用户列表',
  'menu.message': '留言管理',
  'menu.message.list': '留言列表',
  'menu.link': '友情链接',
  'menu.link.list': '友情链接列表',
  'menu.category': '菜谱分类管理',
  'menu.category.list': '菜谱分类列表',
  'menu.dashboard': '数据分析',
  ...
  'menu.news': '健康资讯管理',
  'menu.news.list': '健康资讯列表',
  'menu.newsTag': '健康资讯标签',
  'menu.newsTag.list': '健康资讯标签列表',
  'menu.news.create': '新建资讯',
  'menu.account.trigger': '触发报错',
  'menu.account.logout': '退出登录',
  'app.login.tab-login-credentials': '邮箱密码登录',
